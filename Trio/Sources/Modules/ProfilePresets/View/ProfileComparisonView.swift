    ...
    struct ComparisonView: View {
        ...
        private var dynamicComparisonSection: some View {
            Section(
                ...
                decimalComparisonRow(
                    label: String(localized: "Adjustment Factor", comment: "ProfileComparison: Dynamic ISF setting"),
                ...
                boolComparisonRow(
                    label: String(localized: "TDD Adj Basal", comment: "ProfileComparison: Dynamic ISF setting"),
