...
extension Stat.StateModel {
    ...
    private func fetchTDDStats() async throws -> (hourly: [TDDStats], daily: [TDDStats]) {
        ...
        let tddResults = try await fetchTDDStoredRecords(on: tddTaskContext, daysBack: daysBack)
    ...
    private func fetchTDDStoredRecords(on tddTaskContext: NSManagedObjectContext, daysBack: Int) async throws -> Any {
