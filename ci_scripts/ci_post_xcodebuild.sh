...
# base branch (default: build/dev, the pristine upstream release we build on)
# — i.e. the fork features included in this build.
#
...
# automatic, so good merge/PR subject lines keep these notes readable.
...
BASE_BRANCH="${WHATTOTEST_BASE_BRANCH:-build/dev}"   # diff this branch against here
